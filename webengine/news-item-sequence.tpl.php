				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
                            ...
                            <a class="btn ripple btn-info" href="news-item-list.php"><i class="fe fe-list me-2"></i>Item List</a>
						</div>
						<div class="justify-content-center mt-2">
					...
					<!--Row-->						
						<div class="row row-sm">
							<div class="col-lg-12">
								<div class="card custom-card">
									<div class="card-body">
                                    <form enctype="multipart/form-data" method="post" action="news-item-action" id="form2" name="form2">
...
function SetAction(val) {
 ...
 // alert(sequence);	
  ...
  document.getElementById('form2').action = 'news-item-action.php';
