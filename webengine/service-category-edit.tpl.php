										...
										<div class="example">
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_consumer_category/<?= $this->item->image_la ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_consumer_category/<?= $this->item->image_en ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_consumer_category/<?= $this->item->image_cn ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<label class="custom-switch ps-0">
												...
												<div class="form-row">
													<div class="col-sm-6">
													<img src="../img_consumer_category/<?= $this->item->image_vi ?>" width="400">
													</div>
												</div>
												</div>
												<?php } ?>
	...
	function checkForm() {
		...
		/*	
			...
			*/
			...
			SetAction('service-category-action.php');
		}
	}
