  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('service-category-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("service-category-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('service-category-action.php?do=listupdate');   
      }     
    } 
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="service-category-add.php?parent_id=<?=$this->parent_id?>"><i class="fe fe-plus me-2"></i>Add Data</a>
							
							<a class="btn ripple btn-info" href="service-category-sequence.php?parent_id=<?=$this->parent_id?>"><i class="fe fe-list me-2"></i>Sequence</a>
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												...
												<tbody>
													...
													<tr>
															...
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<p>consumer-page.php?parent_id=<?=$val['id']?></p>
																	</div>
														...
														<td class="text-center"><a href="service-group-list.php?parent_id=<?=$val['id']?>"><span class="badge badge-danger"> <?=$val['item_amount']?> items </span></a></td>
														<td class="text-center"><?php if($val['image_la'] != ''){ ?><img src="../img_consumer_category/<?=$val['image_la']?>" width="50%"><?php } ?></td>														
														<td>
														...
														<td class="text-center"><div>
															<a href="service-category-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-info-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a></div>
															<div style="padding-top: 5px;">
															<a href="service-category-action.php?do=delete&id=<?=$val['id']?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
