				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="article-item-add.php"><i class="fe fe-plus me-2"></i>Add Data</a>
						</div>
						<div class="justify-content-center mt-2">
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php if($val['image'] != ''){ ?><img src="../img_article/<?=$val['image']?>" width="100%"><?php } ?></td>
														<td>
														...
														<td class="text-center"><a href="article-layer-list.php?parent_id=<?=$val['id']?>"><span class="badge badge-danger"> <?=$val['layer_amount']?> items </span></a></td>
														<td class="text-center"><span class="badge badge-danger"> 0 items </span></td>
														<td>
														...
														<td class="text-center"><div>
															<a href="article-item-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-primary-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a></div>
															<div style="padding-top: 5px;">
															<a href="article-item-action.php?do=delete&id=<?=$val['id']?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
