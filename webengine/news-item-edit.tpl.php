										...
										<div class="example">
											<div class="panel panel-primary tabs-style-2">
												<div class=" tab-menu-heading">
													<div class="tabs-menu1">
														...
														<ul class="nav panel-tabs main-nav-line">
															<li><a href="#CATE" class="nav-link active" data-bs-toggle="tab">Category</a></li>
															<li><a href="#LA" class="nav-link" data-bs-toggle="tab">Lao</a></li>
												...
												<div class="checkbox checbox-switch switch-success">
											     <label><input type="checkbox" name="cate_id[]" id="cate_id<?=$i?>" wfd-invisible="true" value="<?=$val['id']?>"<?=(in_array($val['id'],$this->categoryCheck)) ? ' checked':''?>> <span> </span>&nbsp;&nbsp; <?=$val['title_la']?> <?=($val['title_en'] != '')? ' /'.$val['title_en']:'' ?></label>
											     </div>
												 <?php } ?>   
											...
											<?php if($this->item->thumbnail != ''){ ?>
												<BR>
												 <div class="control-group form-group">
												  <div class="form-row">
													<div class="col-sm-2">
													  <img src="../img_news/<?= $this->item->thumbnail ?>" width="100">
													</div>
												  </div>
												  </div>
												  <?php } ?>
												...
												<?php if($this->item->image != ''){ ?>
												 <div class="control-group form-group">
												  <div class="form-row">
													<div class="col-sm-2">
													  <img src="../img_news/<?= $this->item->image ?>" width="200">
													</div>
												  </div>
												  </div>
												  <?php } ?>
...
<script type="text/javascript">
	function checkForm() {
		with (document.form1) {
			...
			SetAction('news-item-action.php');
		}
	}
