									...
									<div class="text-wrap">
										<div class="example">
											...
											<div class="control-group form-group">
												...
												<input type="text" class="form-control" placeholder="Country Name" id="country_name" name="country_name" value="<?= ($_SESSION['item_form']['country_name'] != null) ? $_SESSION['item_form']['country_name'] : $this->item->country_name ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Country Code</label>
												<input type="text" class="form-control" placeholder="Network Name" id="country_code" name="country_code" value="<?= ($_SESSION['item_form']['country_code'] != null) ? $_SESSION['item_form']['country_code'] : $this->item->country_code ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Abbreviation</label>
												<input type="text" class="form-control" placeholder="Abbreviation" id="country_value" name="country_value" value="<?= ($_SESSION['item_form']['country_value'] != null) ? $_SESSION['item_form']['country_value'] : $this->item->country_value ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Price (LAK/Min) </label>
												<input type="text" class="form-control" placeholder="Price (LAK/Min)" id="qtaBalance" name="qtaBalance" value="<?= ($_SESSION['item_form']['qtaBalance'] != null) ? $_SESSION['item_form']['qtaBalance'] : $this->item->qtaBalance ?>">
											</div>
...
<script type="text/javascript">
	function checkForm() {
		...
		*/	
			SetAction('iddcall-item-action.php');
		}
	}
