										...
										<div class="example">
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_banner/thumbnail/<?= $this->item->image_la ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<?php if($this->item->imagem_la != ''){ ?>
											 ...
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_banner/thumbnail/<?= $this->item->imagem_la ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_banner/thumbnail/<?= $this->item->image_en ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<?php if($this->item->imagem_en != ''){ ?>
											 ...
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_banner/thumbnail/<?= $this->item->imagem_en ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_banner/thumbnail/<?= $this->item->image_cn ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<?php if($this->item->imagem_cn != ''){ ?>
											 ...
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_banner/thumbnail/<?= $this->item->imagem_cn ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_banner/thumbnail/<?= $this->item->image_vi ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<?php if($this->item->imagem_vi != ''){ ?>
											 ...
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_banner/thumbnail/<?= $this->item->imagem_vi ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
	...
	function checkForm() {
		with (document.form1) {
			...
			*/
			...
			SetAction('banner-item-action.php');
		}
	}
