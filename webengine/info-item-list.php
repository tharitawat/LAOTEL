...
$sql = "SELECT i.*, (SELECT Count(id) FROM info_layers t WHERE t.parent_id = i.id) AS layer_amount
FROM info_items i WHERE 1 = 1 AND i.parent_id = ".$db->qstr($gettmp['parent_id'])." 
".$sql_keyword."
".$sql_date_begin."
".$sql_date_end."
