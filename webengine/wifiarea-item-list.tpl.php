  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('wifiarea-item-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("wifiarea-item-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('wifiarea-item-action.php?do=listupdate');   
      }     
    } 
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<span class="main-content-title mg-b-0 mg-b-lg-1">WIFI Service Area</span>
						</div>
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="wifiarea-item-add.php?parent_id=<?=$this->parent_id?>"><i class="fe fe-plus me-2"></i>Add Data</a>
						</div>
						<div class="justify-content-center mt-2">
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												<thead>
													<tr>
														...
														<th width="15%">Number of Access Points</th>
														<th width="15%">Indoor of Access Points</th>
														<th width="15%">Outdoor of Access Points</th>
												...
												<tbody>
													...
													<tr>
														...
														<td class="text-center"><?=$val['number_point']?></td>
														<td class="text-center"><?=$val['indoor_point']?></td>
														<td class="text-center"><?=$val['outdoor_point']?></td>
														<td>
														...
														<td class="text-center"><div>
															<a href="wifiarea-item-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-info-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a></div>
															<div style="padding-top: 5px;">
															<a href="wifiarea-item-action.php?do=delete&id=<?=$val['id']?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
