					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"><?=$this->cate->title_la?></li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
										...
										<div class="example">
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_consumer_group/<?= $this->item->image_la ?>" width="200">
												</div>
											  </div>
												 <a href="service-group-action.php?do=delete_image_la&id=<?=$this->item->id?>"><span class="text-warning"> Delete</span></a>
											  </div>
											  <?php } ?>
											<div class="control-group form-group">
												<label class="form-label">Image Banner (LA)</label>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_consumer_group/<?= $this->item->image_en ?>" width="200">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											<div class="control-group form-group">
												<label class="form-label">Image Banner (EN)</label>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_consumer_group/<?= $this->item->image_cn ?>" width="200">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											<div class="control-group form-group">
												<label class="form-label">Image Banner (CN)</label>
											...
											<label class="custom-switch ps-0">
												...
												<div class="form-row">
													<div class="col-sm-6">
													<img src="../img_consumer_group/<?= $this->item->image_vi ?>" width="200">
													</div>
												</div>
												</div>
												<?php } ?>
												<div class="control-group form-group">
													<label class="form-label">Image Banner (VI)</label>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_consumer_group/<?= $this->item->image ?>">
												</div>
											  </div>
											  </div>
											  <?php } ?>
	...
	function checkForm() {
		...
		/*	
			...
			*/
			...
			SetAction('service-group-action.php');
		}
	}
