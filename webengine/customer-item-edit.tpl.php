						...
						<div class="col-xl-12">
									...
									<div class="text-wrap">
										<div class="example">
											<div class="panel panel-primary tabs-style-2">
												...
												<div class="control-group form-group">
												<label class="form-label">URL (TH)</label>
												<input type="text" class="form-control" placeholder="URL" id="url_th" name="url_th" value="<?= ($_SESSION['item_form']['url_th'] != null) ? $_SESSION['item_form']['url_th'] : $this->item->url_th ?>">
												</div>
											
											
											<?php if($this->item->image_th != ''){ ?>
											 <div class="control-group form-group">
												 <label class="form-label"><?=$this->item->image_alt_th ?></label>
											  <div class="form-row">
												<div class="col-sm-1">
												  <img src="../img_customer/<?= $this->item->image_th ?>" width="100">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											<div class="control-group form-group">
												...
												<span class="text-warning"> Size 300px x 300px (format .jpg, .png)</span>
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Alt Image (TH)</label>
												<input type="text" class="form-control" placeholder="Alt Image" name="image_alt_th" id="image_alt_th" value="<?= ($_SESSION['item_form']['image_alt_th'] != null) ? $_SESSION['item_form']['image_alt_th'] : $this->item->image_alt_th ?>">
											</div>
											...
											<?php if($this->item->image_en != ''){ ?>
											 <div class="control-group form-group">
												  <label class="form-label"><?=$this->item->image_alt_en ?></label>
											  <div class="form-row">
												<div class="col-sm-1">
												  <img src="../img_customer/<?= $this->item->image_en ?>" width="100">
												</div>
											  </div>
											  </div>
											  <?php } ?>
							...
							<div class="col-lg-12 col-md-12">
								...
								<div class="form-group">
									...
									<input type="hidden" name="id" id="id" value="<?= $this->item->id ?>" />
	...
	function checkForm() {
		with (document.form1) {
			...
			*/
			...
			SetAction('customer-item-action.php');
		}
	}
