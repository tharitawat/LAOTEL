  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('submenu-item-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("submenu-item-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('submenu-item-action.php?do=listupdate');   
      }     
    } 
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="submenu-item-add.php?parent_id=<?=$this->parent_id?>&menu_id=<?=$this->menu_id?>"><i class="fe fe-plus me-2"></i>Add Data</a>
						</div>
						<div class="justify-content-center mt-2">
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												...
												<tbody>
													...
													<tr>
														...
														<td class="text-center"><a href="groupmenu-item-list.php?parent_id=<?=$val['id']?>&menu_id=<?=$this->menu_id?>"><span class="badge badge-danger"> <?=$val['menu_amount']?> items </span></a></td>
														<td><?php if($val['image'] != ''){ ?><img src="../img_submenu/<?=$val['image']?>" width="100%"><?php } ?></td>														
														<td>
														...
														<td class="text-center"><div>
															<a href="submenu-item-edit.php?id=<?=$val['id']?>&menu_id=<?=$this->menu_id?>" class="btn btn-icon btn-info-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a></div>
															<div style="padding-top: 5px;">
															<a href="submenu-item-action.php?do=delete&id=<?=$val['id']?>&menu_id=<?=$this->menu_id?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
