								...
								<div class="card-body">
									...
									<div class="text-wrap">
										...
										<div class="control-group form-group">
												<label class="form-label">Location(LAO)</label>
												<input type="text" class="form-control" placeholder="Location" id="location" name="location" value="<?= ($_SESSION['item_form']['location'] != null) ? $_SESSION['item_form']['location'] : $this->item->location ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Number of Access Points</label>
												<input type="text" class="form-control" placeholder="Amount" id="number_point" name="number_point" value="<?= ($_SESSION['item_form']['number_point'] != null) ? $_SESSION['item_form']['number_point'] : $this->item->number_point ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Indoor of Access Points</label>
												<input type="text" class="form-control" placeholder="Amount" id="indoor_point" name="indoor_point" value="<?= ($_SESSION['item_form']['indoor_point'] != null) ? $_SESSION['item_form']['indoor_point'] : $this->item->indoor_point ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Outdoor of Access Points</label>
												<input type="text" class="form-control" placeholder="Amount " id="outdoor_point" name="outdoor_point" value="<?= ($_SESSION['item_form']['outdoor_point'] != null) ? $_SESSION['item_form']['outdoor_point'] : $this->item->outdoor_point ?>">
											</div>
...
<script type="text/javascript">
	function checkForm() {
		...
		*/	
			SetAction('wifiarea-item-action.php');
		}
	}
