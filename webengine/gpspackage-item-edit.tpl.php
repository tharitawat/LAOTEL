									...
									<div class="text-wrap">
										<div class="example">																						
											...
											<div class="control-group form-group">
												<label class="form-label">Package Data</label>
												<input type="text" class="form-control" placeholder="Package Data" id="qtaData" name="qtaData" value="<?= ($_SESSION['item_form']['qtaData'] != null) ? $_SESSION['item_form']['qtaData'] : $this->item->qtaData ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Balance Value of 1 Month</label>
												<input type="text" class="form-control" placeholder="1 Month" id="qta01" name="qta01" value="<?= ($_SESSION['item_form']['qta01'] != null) ? $_SESSION['item_form']['qta01'] : $this->item->qta01 ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Balance Value of 3 Month</label>
												<input type="text" class="form-control" placeholder="3 Month" id="qta03" name="qta03" value="<?= ($_SESSION['item_form']['qta03'] != null) ? $_SESSION['item_form']['qta03'] : $this->item->qta03 ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Balance Value of 6 Month</label>
												<input type="text" class="form-control" placeholder="6 Month" id="qta06" name="qta06" value="<?= ($_SESSION['item_form']['qta06'] != null) ? $_SESSION['item_form']['qta06'] : $this->item->qta06 ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Balance Value of 12 Month</label>
												<input type="text" class="form-control" placeholder="12 Month" id="qta12" name="qta12" value="<?= ($_SESSION['item_form']['qta12'] != null) ? $_SESSION['item_form']['qta12'] : $this->item->qta12 ?>">
											</div>
...
<script type="text/javascript">
	function checkForm() {
		with (document.form1) {
			...
			SetAction('gpspackage-item-action.php');
		}
	}
