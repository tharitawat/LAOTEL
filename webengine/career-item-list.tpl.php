  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('career-item-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("career-item-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('career-item-action.php?do=listupdate');   
      }     
    } 
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item " aria-current="page"><a href="career-item-list.php?parent_id=<?=$this->item->parent_id?>">Career</a></li>
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php if($val['image'] != ''){ ?><img src="../img_career/<?=$val['image']?>" width="100%"><?php } ?></td>
														<td class="text-center"><a href="career-layer-list.php?parent_id=<?=$val['id']?>"><span class="badge badge-danger"> <?=$val['layer_amount']?> items </span></a></td>
														<td>
															<span class="text-muted tx-13">
															<select class="form-select border" id="status_display<?=$val['id']?>" name="status_display<?=$val['id']?>" style="width: 100px" onchange="editStatusOnline('career',<?=$val['id']?>,this.value);">
														...
														<td class="text-center"><div>
															<a href="career-item-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-info-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
