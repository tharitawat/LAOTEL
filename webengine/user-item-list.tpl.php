											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<p class="tx-14 font-weight-semibold text-dark mb-1"><?=$val['fullname']?></p>
														...
														<td>
															<span class="badge bg-light text-muted tx-13"><?=($val['type'] == '1')?'Super Admin':'Admin'?></span>
														</td>
														<td>
															<span class="text-muted tx-13"><?=date('d/m/Y',strtotime($val['lastlogin_date']))?></span>
														</td>
														<td>
															<span class="text-muted tx-13"><?=date('d/m/Y',strtotime($val['created_date']))?></span>
														</td>
														<td class="text-center"><div>
															<a href="user-item-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-info-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
