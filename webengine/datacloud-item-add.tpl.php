									...
									<div class="text-wrap">
										<div class="example">
											...
											<div class="control-group form-group">
												...
												<input type="text" class="form-control" placeholder="qtaVcpu" id="qtaVcpu" name="qtaVcpu" value="<?= ($_SESSION['item_form']['qtaVcpu'] != null) ? $_SESSION['item_form']['qtaVcpu'] : $this->item->qtaVcpu ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Mem (GB)</label>
												<input type="text" class="form-control" placeholder="qtaMem" id="qtaMem" name="qtaMem" value="<?= ($_SESSION['item_form']['qtaMem'] != null) ? $_SESSION['item_form']['qtaMem'] : $this->item->qtaMem ?>">
											</div>																				
											
											<div class="control-group form-group">
												<label class="form-label">Disk (GB)</label>
												<input type="text" class="form-control" placeholder="Value Data" id="qtaDisk" name="qtaDisk" value="<?= ($_SESSION['item_form']['qtaDisk'] != null) ? $_SESSION['item_form']['qtaDisk'] : $this->item->qtaDisk ?>">
											</div>
	...
	function checkForm() {
		...
		/*	
			...
			*/
			...
			SetAction('datacloud-item-action.php');
		}
	}
