...
if ($gettmp["search_key"] != null) {
	$sql_keyword = "AND CONCAT_WS('', i.country_name, i.operator_name, i.network_name, i.local_call) LIKE ".$db->qstr("%".Utility::encodeToDB($gettmp["search_key"])."%")." ";
}

$sql = "SELECT i.*,NULL AS DUMMY FROM brand_items i WHERE 1 = 1 
