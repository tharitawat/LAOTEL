				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1"><?=Lang::getMenuMain($this->menu_id)?></span>
						</div>
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								<li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Home</a></li>
								<li class="breadcrumb-item" aria-current="page">Menu Manage</li>
								<li class="breadcrumb-item" aria-current="page"><a href="menu-item-list.php?menu_id=<?=$this->menu_id?>"><?=Lang::getMenuMain($this->menu_id)?></a></li>
								<li class="breadcrumb-item" aria-current="page"><?=$this->menu->title_la?></li>
								<li class="breadcrumb-item active" aria-current="page"><?=$this->submenu->title_la?></li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
						...
						<div class="col-xl-12">
										...
										<div class="example">
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_submenu/<?= $this->item->image ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
							...
							<div class="col-lg-12 col-md-12">
								...
								<div class="form-group">
									...
									<input type="hidden" name="menu_id" id="menu_id" value="<?=$this->menu_id?>" />
	...
	function checkForm() {
		...
		/*	
			...
			*/
			...
			SetAction('groupmenu-item-action.php');
		}
	}
