												...
												<div class="panel-body tabs-menu-body main-content-body-right border">
													...
													<BR><BR>		
													 <div class="control-group form-group">
													  ...
													  <a href="download-item-action.php?do=delete_file_la&id=<?=$this->item->id?>">Delete</a>	 
													  </div>
														<BR>	
												  <?php } ?>		
													...
													<BR><BR>		
													 <div class="control-group form-group">
													  <div class="form-row">
														...
														<a href="download-item-action.php?do=delete_file_en&id=<?=$this->item->id?>">Delete</a>	 
													  </div>
														<BR>	
												  <?php } ?>
													...
													<BR><BR>		
													 <div class="control-group form-group">
													  ...
													  <a href="download-item-action.php?do=delete_file_cn&id=<?=$this->item->id?>">Delete</a>		 
													  </div>
														<BR>	
												  <?php } ?>		
													...
													<BR><BR>		
													 <div class="control-group form-group">
													  ...
													  <a href="download-item-action.php?do=delete_file_vi&id=<?=$this->item->id?>">Delete</a>		 
													  </div>
														<BR>	
												  <?php } ?>		
