				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">SPECIAL BANNER</span>
						</div>
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								<li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Home</a></li>
								<li class="breadcrumb-item" aria-current="page">Content Pages</li>
								<li class="breadcrumb-item active" aria-current="page">Special Banner</li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
										...
										<div class="example">
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_special/thumbnail/<?= $this->item->image_la ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<?php if($this->item->imagem_la != ''){ ?>
											 ...
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_special/thumbnail/<?= $this->item->imagem_la ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_special/thumbnail/<?= $this->item->image_en ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<?php if($this->item->imagem_en != ''){ ?>
											 ...
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_special/thumbnail/<?= $this->item->imagem_en ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_special/thumbnail/<?= $this->item->image_cn ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<?php if($this->item->imagem_cn != ''){ ?>
											 ...
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_special/thumbnail/<?= $this->item->imagem_cn ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_special/thumbnail/<?= $this->item->image_vi ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<?php if($this->item->imagem_vi != ''){ ?>
											 ...
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_special/thumbnail/<?= $this->item->imagem_vi ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
	...
	function checkForm() {
		with (document.form1) {
			...
			*/
			...
			SetAction('special-item-action.php');
		}
	}
