...
$sql = "SELECT * FROM consumer_service_files i WHERE 1=1 AND i.parent_id = ? ";
$stmt = $db->Prepare($sql);
...
$sql = "SELECT * FROM consumer_service_files i WHERE 1 = 1 AND i.parent_id = ? ".$sql_keyword."  ORDER BY ".$sql_sort;
$stmt = $db->Prepare($sql);
