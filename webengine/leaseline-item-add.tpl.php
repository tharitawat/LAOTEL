									...
									<div class="text-wrap">
										<div class="example">
											...
											<div class="control-group form-group">
												...
												<input type="text" class="form-control" placeholder="Package Data" id="valueLeft" name="valueLeft" value="<?= ($_SESSION['item_form']['valueLeft'] != null) ? $_SESSION['item_form']['valueLeft'] : $this->item->valueLeft ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Balance Value</label>
												<input type="text" class="form-control" placeholder="Balance Value" id="valueRight" name="valueRight" value="<?= ($_SESSION['item_form']['valueRight'] != null) ? $_SESSION['item_form']['valueRight'] : $this->item->valueRight ?>">
											</div>
	...
	function checkForm() {
		...
		/*	
			...
			*/
			...
			SetAction('leaseline-item-action.php');
		}
	}
