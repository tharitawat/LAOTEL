				...
				<div class="main-container container-fluid">
						...
						<div class="card custom-card">
                            ...
                            <table  border="0" cellpadding="4" cellspacing="0">
                                ...
                                <tr>
                                  <td class="notable-data">&nbsp;</td>
                                  <td>
								<select class="form-select border w-250" name="jumpMenu" id="jumpMenu" style="width: 300px;" onChange="MM_jumpMenuGo('jumpMenu','parent',0)">
                                        <option value="">Select Service Type</option>
										 <option value="?parent_id=1"<?=($this->parent_id == '1') ?' selected':''?>>Package and Service</option>  
										 <option value="?parent_id=2"<?=($this->parent_id == '2') ?' selected':''?>>Internet Fiber</option>  
										 <option value="?parent_id=3"<?=($this->parent_id == '3') ?' selected':''?>>Privilege</option>  
                                        </select>	
								  </td>
                                </tr>            
                                </table>
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
                            ...
                            <a class="btn ripple btn-info" href="service-item-list.php"><i class="fe fe-list me-2"></i>Item List</a>
						</div>
						<div class="justify-content-center mt-2">
...
function SetAction(val) {
 ...
 // alert(sequence);	
  ...
  document.getElementById('form2').action = 'service-item-action.php';
