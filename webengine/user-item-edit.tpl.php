								...
								<div class="card-body">
									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal" role="form" data-toggle="validator" name="form1" id="form1" action="">
											...
											<div class="control-group form-group">
												...
												<input type="email" class="form-control required" placeholder="Email Address" id="email" name="email" value="<?= ($_SESSION['user']['email'] != null) ? $_SESSION['user']['email'] : $this->item->email ?>" readonly>
											...
											<div class="row">											
												...
												<div class="col-sm-4 ">
													<div class="form-group mb-0">
														...
														<input class="form-control" id="datepicker-date" placeholder="MM/DD/YYYY HH:MM" type="text" readonly>
													</div>
												</div>
											</div>
