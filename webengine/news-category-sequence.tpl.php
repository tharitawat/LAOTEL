				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">Content Pages</li>
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
                            ...
                            <a class="btn ripple btn-info" href="news-category-list.php"><i class="fe fe-list me-2"></i>Item List</a>
						</div>
						<div class="justify-content-center mt-2">
					...
					<!--Row-->						
						<div class="row row-sm">
							<div class="col-lg-12">
								<div class="card custom-card">
									<div class="card-body">
                                    <form enctype="multipart/form-data" method="post" action="news-category-action" id="form2" name="form2">
											...
											<table id="user-datatable" class="table table-bordered border-bottom Userlist">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td><?php if ($val['title_la'] != null) { ?><a href="news-category-edit.php?id=<?= $val['id'] ?>"><?= $val['title_la'] ?></a><br /><?php } // if ?></td>
                                                        <td><?php if ($val['title_en'] != null) { ?><a href="news-category-edit.php?id=<?= $val['id'] ?>"><?= $val['title_en'] ?></a><br /><?php } // if ?></td>
														<td>
															<span class="text-muted tx-13">
															<select class="form-select border" id="status_display<?=$val['id']?>" name="status_display<?=$val['id']?>" style="width: 100px" onchange="editStatusOnline('ArticleCategory',<?=$val['id']?>,this.value);">
														...
														<td class="text-center"><div>
															<a href="news-category-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-primary-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
...
function SetAction(val) {
 ...
 // alert(sequence);	
  ...
  document.getElementById('form2').action = 'news-category-action.php';
