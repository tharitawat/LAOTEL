									...
									<div class="text-wrap">
										<div class="example">
											...
											<div class="control-group form-group">
												...
												<input type="text" class="form-control" placeholder="Brand Name" id="title" name="title" value="<?= ($_SESSION['item_form']['title'] != null) ? $_SESSION['item_form']['title'] : $this->item->title ?>">
											</div>										
...
<script type="text/javascript">
	function checkForm() {
		...
		*/	
			SetAction('brand-item-action.php');
		}
	}
