				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">SERVICE ITEMS</span>
						</div>
										...
										<div class="example">
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_service/thumbnail/<?= $this->item->image_la ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_service/thumbnail/<?= $this->item->image_en ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_service/thumbnail/<?= $this->item->image_cn ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_service/thumbnail/<?= $this->item->image_vi ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
													...
													<select class="form-select border" id="parent_id" name="parent_id">
														<option value="">Select Category</option>
														<option value="1"<?=((($_SESSION['item_form']['parent_id'] != null) && ($_SESSION['item_form']['parent_id'] == 1)) || (($_SESSION['item_form']['parent_id'] == null) && ($this->item->parent_id == 1))) ? ' selected':''?>>Package and Service</option>
														<option value="2"<?=((($_SESSION['item_form']['parent_id'] != null) && ($_SESSION['item_form']['parent_id'] == 2)) || (($_SESSION['item_form']['parent_id'] == null) && ($this->item->parent_id == 2))) ? ' selected':''?>>Internet Fiber</option>
														<option value="3"<?=((($_SESSION['item_form']['parent_id'] != null) && ($_SESSION['item_form']['parent_id'] == 3)) || (($_SESSION['item_form']['parent_id'] == null) && ($this->item->parent_id == 3))) ? ' selected':''?>>Privilege</option>
													</select>
											</div>
	...
	function checkForm() {
		...
		/*
			...
			*/
			...
			SetAction('service-item-action.php');
		}
	}
