  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('contact-item-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("contact-item-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('contact-item-action.php?do=listupdate');   
      }     
    } 
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<span class="main-content-title mg-b-0 mg-b-lg-1">ENQUIRY</span>
						</div>
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<p class="tx-14 font-weight-semibold text-dark mb-1"><?=$val['contact_name']?></p>
															
														</td>
														<td>
															<p class="tx-14 font-weight-semibold text-dark mb-1"><?=$val['contact_tel']?></p>
														
														</td>
														<td>
															<p class="tx-13 text-muted mb-0"><?=$val['contact_mail']?></p>
														</td>
														<td>
															<p class="tx-13 text-muted mb-0" style="width:20%"><?=$val['contact_message']?></p>
														</td>
														<td>
														...
														<td class="text-center">
															<!-- <div>
															<a href="contact-item-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-primary-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a>
															</div>
															-->
															<div style="padding-top: 5px;">
															<a href="contact-item-action.php?do=delete&id=<?=$val['id']?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
