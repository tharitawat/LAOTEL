  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('article-layer-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("article-layer-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('article-layer-action.php?do=listupdate');   
      }     
    } 
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="justify-content-center mt-2">
                            ...
                            <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Home</a></li>
								...
								<li class="breadcrumb-item active" aria-current="page"><?=$this->item->title_th?></li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
					...
					<div class="col-lg-12">
						<div class="card custom-card">
                            ...
                            <table  border="0" cellpadding="4" cellspacing="0">
                                ...
                                <td>
                                <select class="custom-select w-250" name="sequence_by" id="sequence_by" style="width: 300px;">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="article-layer-add.php?parent_id=<?=$this->parent_id?>"><i class="fe fe-plus me-2"></i>Add Data</a>
                            <a class="btn ripple btn-info" href="article-layer-list.php?parent_id=<?=$this->parent_id?>"><i class="fe fe-list me-2"></i>Item List</a>
						</div>
						<div class="justify-content-center mt-2">
						...
						<div class="row row-sm">
							<div class="col-lg-12">
								<div class="card custom-card">
                                    ...
                                    <input type="hidden" name="group_id" id="group_id" value="<?=$this->group->id?>">
											...
											<table id="user-datatable" class="table table-bordered border-bottom Userlist">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td><?php if ($val['title_th'] != null) { ?><a href="product-layer-edit.php?id=<?= $val['id'] ?>"><?= $val['title_th'] ?></a><br /><?php } // if ?></td>
                                                        <td><?php if ($val['title_en'] != null) { ?><a href="product-layer-edit.php?id=<?= $val['id'] ?>"><?= $val['title_en'] ?></a><br /><?php } // if ?></td>
														<td>
															<span class="text-muted tx-13">
															<select class="custom-select" id="status_display<?=$val['id']?>" name="status_display<?=$val['id']?>" style="width: 100px" onchange="editStatusOnline('Banner',<?=$val['id']?>,this.value);">
															<option value="Online"<?=($val['status'] == 'Online')? ' selected': ''?>>Online</option>
															<option value="Offline"<?=($val['status'] == 'Offline')? ' selected': ''?>>Offline</option>
															</select>
															</span>
														</td>
														<td>
														...
														<td class="text-center"><div>
															<a href="article-layer-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-primary-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a></div>
															<div style="padding-top: 5px;">
															<a href="article-layer-action.php?do=delete&id=<?=$val['id']?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
...
function SetAction(val) {
 ...
 // alert(sequence);	
  ...
  document.getElementById('form2').action = 'article-layer-action.php';
