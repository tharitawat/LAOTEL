  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('roaming-item-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("roaming-item-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('roaming-item-action.php?do=listupdate');   
      }     
    } 
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="roaming-item-add.php?parent_id=<?=$this->parent_id?>"><i class="fe fe-plus me-2"></i>Add Data</a>
						</div>
						<div class="justify-content-center mt-2">
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												<thead>
													<tr>
														...
														<th width="15%">Network Name</th>
														<th width="15%">Local Call (Kip/Min)</th>
														<th width="10%">Data Kip/Kb</th>
														<th width="10%">IRA</th>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<p class="tx-14 font-weight-semibold text-dark mb-1"><?=$val['country_name']?> <?=$val['country_code']?></p>
														</td>
														<td class="text-center"><?=($val['type'] == '1') ? 'Post Paid':'Pre Paid'?></td>
														<td class="text-center"><?=$val['operator_name']?></td>
														<td class="text-center"><?=$val['network_name']?></td>
														<td class="text-center"><?=$val['local_call']?></td>
														<td class="text-center"><?=$val['data_value']?></td>
														<td class="text-center"><?=$val['ira']?></td>
														<td>
														...
														<td class="text-center"><div>
															<a href="roaming-item-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-info-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a></div>
															<div style="padding-top: 5px;">
															<a href="roaming-item-action.php?do=delete&id=<?=$val['id']?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
