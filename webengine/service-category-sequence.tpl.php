				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="service-category-add.php?parent_id=1"><i class="fe fe-plus me-2"></i>Add Data</a>
							
							<a class="btn ripple btn-info" href="service-category-list.php?parent_id=1"><i class="fe fe-list me-2"></i>Item List</a>
...
function SetAction(val) {
 ...
 // alert(sequence);	
  ...
  document.getElementById('form2').action = 'service-category-action.php';
