  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('customer-item-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("customer-item-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('customer-item-action.php?do=listupdate');   
      }     
    } 
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<span class="main-content-title mg-b-0 mg-b-lg-1">OUR CUSTOMER</span>
						</div>
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								<li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Home</a></li>
								<li class="breadcrumb-item" aria-current="page">Content Pages</li>
								<li class="breadcrumb-item active" aria-current="page">Our Customer</li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="customer-item-add.php"><i class="fe fe-plus me-2"></i>Add Data</a>
						</div>
						<div class="justify-content-center mt-2">
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												<thead>
													<tr>
														...
														<th width="20%">Title (TH)</th>
														<th width="30%">Title (EN)</th>
														<th width="10%">Image (TH)</th>
														<th width="10%">Image (EN)</th>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<p class="tx-14 font-weight-semibold text-dark mb-1"><?=$val['title_th']?></p>
														</td>
														<td>
															<p class="tx-14 font-weight-semibold text-dark mb-1"><?=$val['title_en']?></p>
														</td>
														<td><?php if($val['image_th'] != ''){ ?><img src="../img_customer/<?=$val['image_th']?>" width="100%"><?php } ?></td>
														<td><?php if($val['image_en'] != ''){ ?><img src="../img_customer/<?=$val['image_en']?>" width="100%"><?php } ?></td>
														<td>
															...
															<option value="Online"<?=($val['status'] == '1')? ' selected': ''?>>Online</option>
															<option value="Offline"<?=($val['status'] == '0')? ' selected': ''?>>Offline</option>
															</select>
															</span>
														</td>
														<td>
														...
														<td class="text-center"><div>
															<a href="customer-item-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-primary-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a></div>
															<div style="padding-top: 5px;">
															<a href="customer-item-action.php?do=delete&id=<?=$val['id']?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
