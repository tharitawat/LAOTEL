				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page"><a href="career-item-list.php?parent_id=<?=$this->item->parent_id?>"><?=$this->cate->title_la?></a></li>
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="left-content mt-2">
							...
							<a class="btn ripple btn-info" href="career-layer-sequence.php?parent_id=<?=$this->parent_id?>"><i class="fe fe-list me-2"></i>Sequence</a>
						</div>
												...
												<tbody>
													...
													<tr>
														...
														<td class="text-center"><div>
															<a href="career-layer-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-info-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
