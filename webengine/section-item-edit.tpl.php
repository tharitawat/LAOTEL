				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">SECTION BANNER</span>
						</div>
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								<li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Home</a></li>
								<li class="breadcrumb-item" aria-current="page">Content Pages</li>
								<li class="breadcrumb-item active" aria-current="page">Section Banner</li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
									...
									<div class="text-wrap">
										<div class="example">
											<div class="panel panel-primary tabs-style-2">
												...
												<div class="control-group form-group">
												<label class="form-label">URL (LA)</label>
												<input type="text" class="form-control" placeholder="URL" id="url_la" name="url_la" value="<?= ($_SESSION['item_form']['url_la'] != null) ? $_SESSION['item_form']['url_la'] : $this->item->url_la ?>">
												</div>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_section/thumbnail/<?= $this->item->image_la ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
												<label class="form-label">Alt Image (LA)</label>
												<input type="text" class="form-control" placeholder="Alt Image" name="image_alt_la" id="image_alt_la" value="<?= ($_SESSION['item_form']['image_alt_la'] != null) ? $_SESSION['item_form']['image_alt_la'] : $this->item->image_alt_la ?>">
											</div>
															
											<?php if($this->item->imagem_la != ''){ ?>
											 <BR>
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_section/thumbnail/<?= $this->item->imagem_la ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
												<label class="form-label">Image Mobile (LA) </label>
												<input class="form-control" type="file" name="imagem_la" id="imagem_la">
											...
											<label class="custom-switch ps-0">
												...
												<input type="text" class="form-control" placeholder="URL" id="url_en" name="url_en" value="<?= ($_SESSION['item_form']['url_en'] != null) ? $_SESSION['item_form']['url_en'] : $this->item->url_en ?>">
												</div>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_section/thumbnail/<?= $this->item->image_en ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
												...
												<input type="text" class="form-control" placeholder="Alt Image" name="image_alt_en" id="image_alt_en" value="<?= ($_SESSION['item_form']['image_alt_en'] != null) ? $_SESSION['item_form']['image_alt_en'] : $this->item->image_alt_en ?>">
											</div>
															
											<?php if($this->item->imagem_en != ''){ ?>
											 <BR>
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_section/thumbnail/<?= $this->item->imagem_en ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
												<label class="form-label">Image Mobile (EN) </label>
												<input class="form-control" type="file" name="imagem_en" id="imagem_en">
												<span class="text-warning"> Size xxxxxxxxx (format .jpg, .png)</span>
											</div>
											...
											<label class="custom-switch ps-0">
												...
												<div class="control-group form-group">
												<label class="form-label">URL (CN)</label>
												<input type="text" class="form-control" placeholder="URL" id="url_cn" name="url_cn" value="<?= ($_SESSION['item_form']['url_cn'] != null) ? $_SESSION['item_form']['url_cn'] : $this->item->url_cn ?>">
												</div>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_section/thumbnail/<?= $this->item->image_cn ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
												<label class="form-label">Alt Image (CN)</label>
												<input type="text" class="form-control" placeholder="Alt Image" name="image_alt_cn" id="image_alt_cn" value="<?= ($_SESSION['item_form']['image_alt_cn'] != null) ? $_SESSION['item_form']['image_alt_cn'] : $this->item->image_alt_cn ?>">
											</div>
															
											<?php if($this->item->imagem_cn != ''){ ?>
											 <BR>
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_section/thumbnail/<?= $this->item->imagem_cn ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
												<label class="form-label">Image Mobile (CN) </label>
												<input class="form-control" type="file" name="imagem_cn" id="imagem_cn">
												<span class="text-warning"> Size xxxxxxxxx (format .jpg, .png)</span>
											</div>
											...
											<label class="custom-switch ps-0">
												...
												<input type="text" class="form-control" placeholder="URL" id="url_vi" name="url_vi" value="<?= ($_SESSION['item_form']['url_vi'] != null) ? $_SESSION['item_form']['url_vi'] : $this->item->url_vi ?>">
												</div>
											...
											<BR>	
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_section/thumbnail/<?= $this->item->image_vi ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
												<label class="form-label">Alt Image (VI)</label>
												<input type="text" class="form-control" placeholder="Alt Image" name="image_alt_vi" id="image_alt_vi" value="<?= ($_SESSION['item_form']['image_alt_vi'] != null) ? $_SESSION['item_form']['image_alt_vi'] : $this->item->image_alt_vi ?>">
											</div>
															
											<?php if($this->item->imagem_vi != ''){ ?>
											 <BR>
											 <div class="control-group form-group">
											  <div class="form-row">
												<div class="col-sm-6">
												  <img src="../img_section/thumbnail/<?= $this->item->imagem_vi ?>" width="400">
												</div>
											  </div>
											  </div>
											  <?php } ?>
											...
											<div class="control-group form-group">
												<label class="form-label">Image Mobile (VI) </label>
												<input class="form-control" type="file" name="imagem_vi" id="imagem_vi">
												<span class="text-warning"> Size xxxxxxxxx (format .jpg, .png)</span>
											</div>
											...
											<div class="control-group form-group">
													...
													<select class="form-select border" id="position_index" name="position_index">
														<option value="">Select Position</option>
														<option value="1"<?=((($_SESSION['item_form']['position_index'] != null) && ($_SESSION['item_form']['position_index'] == 1)) || (($_SESSION['item_form']['position_index'] == null) && ($this->item->position_index == 1))) ? ' selected':''?>>Top Page</option>
														<option value="2"<?=((($_SESSION['item_form']['position_index'] != null) && ($_SESSION['item_form']['position_index'] == 2)) || (($_SESSION['item_form']['position_index'] == null) && ($this->item->position_index == 2))) ? ' selected':''?>>Middle Page</option>														
													</select>
											</div>
	...
	function checkForm() {
		with (document.form1) {
			...
			*/
			...
			SetAction('section-item-action.php');
		}
	}
