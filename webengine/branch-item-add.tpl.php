										...
										<div class="example">
											...
											<div class="control-group form-group">
													...
													<select class="form-select border" id="parent_id" name="parent_id">
														...
														<option value="1"<?=((($_SESSION['item_form']['parent_id'] != null) && ($_SESSION['item_form']['parent_id'] == 1)) || (($_SESSION['item_form']['parent_id'] == null) && ($this->item->parent_id == 1))) ? ' selected':''?>>Vientiane Capital</option>
														<option value="3"<?=((($_SESSION['item_form']['parent_id'] != null) && ($_SESSION['item_form']['parent_id'] == 3)) || (($_SESSION['item_form']['parent_id'] == null) && ($this->item->parent_id == 3))) ? ' selected':''?>>Central</option>
														<option value="2"<?=((($_SESSION['item_form']['parent_id'] != null) && ($_SESSION['item_form']['parent_id'] == 2)) || (($_SESSION['item_form']['parent_id'] == null) && ($this->item->parent_id == 2))) ? ' selected':''?>>North</option>
														<option value="4"<?=((($_SESSION['item_form']['parent_id'] != null) && ($_SESSION['item_form']['parent_id'] == 4)) || (($_SESSION['item_form']['parent_id'] == null) && ($this->item->parent_id == 4))) ? ' selected':''?>>South</option>
													</select>
											</div>
											...
											<div class="control-group form-group">
												...
												<select class="form-select border" id="province_id" name="province_id">
													<option value="">Select Province</option>
													<?php foreach($this->provinceList as $val){ ?>
													<option value="<?=$val['id']?>"<?=((($_SESSION['item_form']['province_id'] != null) && ($_SESSION['item_form']['province_id'] == $val['id'])) || (($_SESSION['item_form']['province_id'] == null) && ($this->item->province_id == $val['id']))) ? ' selected':''?>><?=$val['prov_name_la']?></option>
													<?php } ?>	
													</select>
												</div>
											
											<div class="control-group form-group">
												<label class="form-label">URL MAP <span class="text-danger">*</span></label>
												<input type="text" class="form-control" placeholder="URL Google Map" id="url_map" name="url_map" value="<?= ($_SESSION['item_form']['url_map'] != null) ? $_SESSION['item_form']['url_map'] : $this->item->url_map ?>">
												</div>


												<div class="control-group form-group">
												<label class="form-label">Latitude</label>
												<input type="text" class="form-control" placeholder="latitude " id="latitude" name="latitude" value="<?= ($_SESSION['item_form']['latitude'] != null) ? $_SESSION['item_form']['latitude'] : $this->item->latitude ?>">
												</div>
													
												<div class="control-group form-group">
												<label class="form-label">Longitude</label>
												<input type="text" class="form-control" placeholder="longitude " id="longitude" name="longitude" value="<?= ($_SESSION['item_form']['longitude'] != null) ? $_SESSION['item_form']['longitude'] : $this->item->longitude ?>">
												</div>
	...
	function checkForm() {
		...
		/*
			...
			*/
			...
			SetAction('branch-item-action.php');
		}
	}
