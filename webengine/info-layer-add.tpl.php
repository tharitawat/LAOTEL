			...
			<div class="main-content app-content">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"><?=$this->info->title_la?></li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
			 ...
			 <?php if($this->item->image_la != ''){ ?>
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_info_layer/thumbnail/<?= $this->item->image_la ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
			  ...
			  <div id="show_layout_image_en">	
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_info_layer/thumbnail/<?= $this->item->image_en ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
			  ...
			  <div id="show_layout_image_cn">
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_info_layer/thumbnail/<?= $this->item->image_cn ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
			  ...
			  <?php if($this->item->image_vi != ''){ ?>
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_info_layer/thumbnail/<?= $this->item->image_vi ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
                ...
                <span class="text-warning"> Ex. https://www.youtube.com/embed/xxx</span>
							...
							<div class="col-lg-12 col-md-12">
								...
								<div class="form-group">
									...
									<a href="info-layer-list.php?parent_id=<?= $this->parent_id ?>">
...
<script type="text/javascript">
	function checkForm() {
		with (document.form1) {
			...
			SetAction('info-layer-action.php');
		}
	}
