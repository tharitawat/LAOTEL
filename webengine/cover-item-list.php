...
if ($gettmp["search_key"] != null) {
	$sql_keyword = "AND CONCAT_WS('', i.title_la, i.title_en,title_vi,title_cn) LIKE ".$db->qstr("%".Utility::encodeToDB($gettmp["search_key"])."%")." ";
}
...
$sql = "
SELECT * FROM cover_items i WHERE 1 = 1 
".$sql_keyword."
".$sql_date_begin."
".$sql_date_end."
