			...
			<div class="main-content app-content">
			  ...
			  <?php if($this->item->image_la != ''){ ?>
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_consumer_service_layer/thumbnail/<?= $this->item->image_la ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
			  ...
			  <?php if($this->item->image_en != ''){ ?>
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_consumer_service_layer/thumbnail/<?= $this->item->image_en ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>				  
			  ...
			  <div class="control-group form-group">
                ...
                <span class="text-warning"> Ex. https://www.youtube.com/embed/xxx</span>
									...
									<div class="control-group form-group">
											<label class="control-label" for="title_cn">Title (CN)</label>
											<div class="mb-2">
 			 ...
 			 <?php if($this->item->image_cn != ''){ ?>
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_consumer_service_layer/thumbnail/<?= $this->item->image_cn ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>				  
			  ...
			  <div class="control-group form-group">
                ...
                <span class="text-warning"> Ex. https://www.youtube.com/embed/xxx</span>
						...
						<div class="tab-pane" id="VI">
							...
							<div class="control-group form-group">
											<label class="control-label" for="title_vi">Title (VI)</label>
											<div class="mb-2">
 			 ...
 			 <?php if($this->item->image_vi != ''){ ?>
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_consumer_service_layer/thumbnail/<?= $this->item->image_vi ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
                ...
                <span class="text-warning"> Ex. https://www.youtube.com/embed/xxx</span>
							...
							<div class="col-lg-12 col-md-12">
								...
								<div class="form-group">
									...
									<a href="consumer-layer-list.php?parent_id=<?= $this->parent_id ?>">
...
<script type="text/javascript">
	function checkForm() {
		with (document.form1) {
			...
			SetAction('consumer-layer-action.php');
		}
	}
