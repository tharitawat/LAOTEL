											...
											<div class="panel panel-primary tabs-style-2">												
												<div class="panel-body tabs-menu-body main-content-body-right border">
												 ...
												 <div class="control-group form-group">
												  <div class="form-row">
													<div class="col-sm-6">
													  <img src="../img_news_gallery/gallery/<?= $this->item->image ?>" width="200">
													</div>
												  </div>
												  </div>
												  <?php } ?>
												...
												<div class="control-group form-group">
													...
													<input type="text" class="form-control" placeholder="Alt Image" name="image_alt" id="image_alt" value="">
												</div>
												
												<div class="control-group form-group">
													<label class="form-label">VDO (Youtube embed) </label>
													<input type="text" class="form-control" placeholder="Youtube" name="youtube_url" id="youtube_url" value="">
