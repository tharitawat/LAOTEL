				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
                            ...
                            <a class="btn ripple btn-info" href="download-item-sequence.php?parent_id=<?=$this->parent_id?>"><i class="fe fe-list me-2"></i>Sequence</a>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">                                  
										<div class="table-responsive  deleted-table">											
											<table id="user-datatable" class="table table-bordered border-bottom Userlist">
												<thead>
													<tr>
													  <th width="5%" class="text-center"><input type="checkbox" name="checkAll" id="checkAll" onClick="checkBox(this);" /></th>
