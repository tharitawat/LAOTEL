  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('branch-item-edit.php?id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction("branch-item-action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        swal("Please select any Check Box");     
        ...
        SetAction('branch-item-action.php?do=listupdate');   
      }     
    } 
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content mt-2">
							<a class="btn ripple btn-primary" href="branch-item-add.php"><i class="fe fe-plus me-2"></i>Add Data</a>
						</div>
						<div class="justify-content-center mt-2">
											...
											<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
												<thead>
													<tr>
														...
														<th width="12%">Title (LA)</th>
														<th width="12%">Title (EN)</th>
														<th width="12%">Title (CN)</th>
														<th width="12%">Title (VI)</th>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<p class="tx-14 font-weight-semibold text-dark mb-1">
																<?php switch($val['parent_id']){
																	case '1': $txt = "Vientiane Capital"; break; 
																	case '2': $txt = "North"; break; 
																	case '3': $txt = "Central"; break; 
																	case '4': $txt = "South"; break; 
																	default:
																}
																?>
																<?=$txt?>	
														...
														<td>
															<p class="tx-14 font-weight-semibold text-dark mb-1"><?=$val['province_title']?></p>
														</td>
														<td>
														...
														<td>
															...
															<select class="form-select border" id="status_display<?=$val['id']?>" name="status_display<?=$val['id']?>" style="width: 100px" onchange="editStatusOnline('Branch',<?=$val['id']?>,this.value);">
														...
														<td class="text-center"><div>
															<a href="branch-item-edit.php?id=<?=$val['id']?>" class="btn btn-icon btn-info-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit">
															<i class="las la-pen"></i></a></div>
															<div style="padding-top: 5px;">
															<a href="branch-item-action.php?do=delete&id=<?=$val['id']?>" class="btn btn-icon btn-danger-light" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete">
