			...
			<div class="main-content app-content">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"><?=$this->news->title_la?></li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
			  ...
			  <div class="control-group form-group">
					  ...
					  <label class="control-label" for="layout_la">Select Show (LA) <span class="text-danger">*</span></label>
						...
						<div class="col-lg-1">
							<label class="rdiobox"><input type="radio" id="layout_la_2" name="layout_la" value="2"<?= ((($_SESSION['item_form']['layout_la'] != null) && ($_SESSION['item_form']['layout_la'] == 2)) || (($_SESSION['item_form']['layout_la'] == null) && ($this->item->layout_la == 2))) ? ' checked' : '' ?>/> <span> VDO</span></label>
						</div>
						<div class="col-lg-1">
			 ...
			 <?php if($this->item->image_la != ''){ ?>
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_news_layer/thumbnail/<?= $this->item->image_la ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
			  ...
			  <div id="show_layout_image_en">	
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_news_layer/thumbnail/<?= $this->item->image_en ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
			  ...
			  <div class="control-group form-group">
					  ...
					  <label class="control-label" for="layout_cn">Select Show (CN) <span class="text-danger">*</span></label>
						...
						<div class="col-lg-1">
							<label class="rdiobox"><input type="radio" id="layout_cn_2" name="layout_cn" value="2"<?= ((($_SESSION['item_form']['layout_cn'] != null) && ($_SESSION['item_form']['layout_cn'] == 2)) || (($_SESSION['item_form']['layout_cn'] == null) && ($this->item->layout_cn == 2))) ? ' checked' : '' ?>/> <span> VDO</span></label>
						</div>
						<div class="col-lg-1">
			  ...
			  <div id="show_layout_image_cn">
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_news_layer/thumbnail/<?= $this->item->image_cn ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
			  ...
			  <div class="control-group form-group">
					  ...
					  <label class="control-label" for="layout_vi">Select Show (VI) <span class="text-danger">*</span></label>
						...
						<div class="col-lg-1">
							<label class="rdiobox"><input type="radio" id="layout_vi_2" name="layout_vi" value="2"<?= ((($_SESSION['item_form']['layout_vi'] != null) && ($_SESSION['item_form']['layout_vi'] == 2)) || (($_SESSION['item_form']['layout_vi'] == null) && ($this->item->layout_vi == 2))) ? ' checked' : '' ?>/> <span> VDO</span></label>
						</div>
						<div class="col-lg-1">
			  ...
			  <?php if($this->item->image_vi != ''){ ?>
				...
				<div class="control-group form-group">
				  <div class="form-row">
					<div class="col-sm-2">
				    <img src="../img_news_layer/thumbnail/<?= $this->item->image_vi ?>" width="100">
					</div>
				  </div>
			  </div>
			  <?php } ?>
                ...
                <span class="text-warning"> Ex. https://www.youtube.com/embed/xxx</span>
							...
							<div class="col-lg-12 col-md-12">
								...
								<div class="form-group">
									...
									<a href="news-layer-list.php?parent_id=<?= $this->parent_id ?>">
...
<script type="text/javascript">
	function checkForm() {
		with (document.form1) {
			...
			SetAction('news-layer-action.php');
		}
	}
