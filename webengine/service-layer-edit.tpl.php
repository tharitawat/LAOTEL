									...
									<div class="text-wrap">
										<div class="example">
											<div class="panel panel-primary tabs-style-2">
												...
												<div class="control-group form-group">
												<label class="form-label">Description (LA)</label>
											...
											<?php if($this->item->thumbnail != ''){ ?>
												<BR>
												 <div class="control-group form-group">
												  <div class="form-row">
													<div class="col-sm-6">
													  <img src="../img_service/group/thumbnail/<?= $this->item->thumbnail ?>" width="400">
													</div>
												  </div>
													 <a href="service-layer-action.php?do=delete_thumbnail&id=<?=$this->item->id?>"><span class="text-warning"> Delete</span></a>
												  </div>
												  <?php } ?>
												<div class="control-group form-group">
												...
												<?php if($this->item->image != ''){ ?>
												 <div class="control-group form-group">
												  <div class="form-row">
													<div class="col-sm-6">
													  <img src="../img_service/group/thumbnail/<?= $this->item->image ?>" width="400">
													</div>
												  </div>
													 <a href="service-layer-action.php?do=delete_image&id=<?=$this->item->id?>"><span class="text-warning"> Delete</span></a> 
												  </div>
												  <?php } ?>
												<div class="control-group form-group">
												...
												<div class="control-group form-group">
													...
													<input class="form-control" type="text" name="image_alt" id="image_alt" value="<?= $this->item->image_alt ?>">
												</div>
												...
												<?php if($this->item->image_icon != ''){ ?>
												 <div class="control-group form-group">
												  <div class="form-row">
													<div class="col-sm-6">
													  <img src="../img_service/group/<?= $this->item->image_icon ?>">
													</div>
												  </div>
													  <a href="service-layer-action.php?do=delete_image_icon&id=<?=$this->item->id?>"><span class="text-warning"> Delete</span></a>
												  </div>
												  <?php } ?>
												<div class="control-group form-group">
													<label class="form-label">Icon </label>
													<input class="form-control" type="file" name="image_icon" id="image_icon">
													<span class="text-warning"> Size xxxxxxx (format .jpg, .png)</span>
												</div>
												
												<div class="control-group form-group">
													<label class="form-label">Youtube </label>
													<input class="form-control" type="text" name="youtube" id="youtube" value="<?= $this->item->youtube ?>">
													<span class="text-warning"> Ex. https://www.youtube.com/embed/YGMEQJXA8yo</span>
												</div>
													
												<?php if($this->item->thumbnail_youtube != ''){ ?>
												<BR>
												 <div class="control-group form-group">
												  <div class="form-row">
													<div class="col-sm-6">
													  <img src="../img_service/group/cover/<?= $this->item->thumbnail_youtube ?>" width="400">
													</div>
												  </div>
													 <a href="service-layer-action.php?do=delete_thumbnail_youtube&id=<?=$this->item->id?>"><span class="text-warning"> Delete</span></a>
												  </div>
												  <?php } ?>
												<div class="control-group form-group">
													<label class="form-label">Thumbnail Youtube</label>
													<input class="form-control" type="file" name="thumbnail_youtube" id="thumbnail_youtube">
													<span class="text-warning"> Size xxxxxxx (format .jpg, .png)</span>
												</div>
												...
												<div class="form-group">
												<label class="form-label">Form Contact</label>
												<label class="custom-switch ps-0">

														<input type="checkbox" name="form_request" id="form_request" value="1" class="custom-switch-input" <?=((($_SESSION['item_form']['form_request'] != null) && ($_SESSION['item_form']['form_request'] == 1)) || (($_SESSION['item_form']['form_request'] == null) && ($this->item->form_request == 1))) ? ' checked=""':''?>>
														<span class="custom-switch-indicator custom-switch-indicator-lg"></span>
													</label>
												</div>	
...
<script type="text/javascript">
	function checkForm() {
		with (document.form1) {
			...
			SetAction('service-layer-action.php');
		}
	}
