				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">FAQ</span>
						</div>
									...
									<div class="text-wrap">
										<div class="example">
											<div class="panel panel-primary tabs-style-2">
												...
												<label class="form-label">Question (LA) <span class="text-danger">*</span></label>
												...
												<div class="control-group form-group">
												<label class="form-label">Answer (LA)</label>
											...
											<label class="custom-switch ps-0">
												...
												<input type="text" class="form-control" placeholder="Question" id="title_en" name="title_en" value="<?= ($_SESSION['item_form']['title_en'] != null) ? $_SESSION['item_form']['title_en'] : $this->item->title_en ?>">
												</div>


												<div class="control-group form-group">
												<label class="form-label">Answer (EN)</label>
												<textarea class="form-control" placeholder="Answer" id="description_en" name="description_en"><?= ($_SESSION['item_form']['description_en'] != null) ? $_SESSION['item_form']['description_en'] : Utility::convTextFromDB($this->item->description_en) ?></textarea>
												</div>
											...
											<label class="custom-switch ps-0">
												...
												<div class="control-group form-group">
												<label class="form-label">Question (CN) <span class="text-danger">*</span></label>
												<input type="text" class="form-control" placeholder="Question" id="title_cn" name="title_cn" value="<?= ($_SESSION['item_form']['title_cn'] != null) ? $_SESSION['item_form']['title_cn'] : $this->item->title_cn ?>">
												</div>


												<div class="control-group form-group">
												<label class="form-label">Answer (CN)</label>
												<textarea class="form-control" placeholder="Answer" id="description_cn" name="description_cn"><?= ($_SESSION['item_form']['description_cn'] != null) ? $_SESSION['item_form']['description_cn'] : Utility::convTextFromDB($this->item->description_cn) ?></textarea>
												</div>
											...
											<label class="custom-switch ps-0">
												...
												<div class="control-group form-group">
												<label class="form-label">Question (VI) <span class="text-danger">*</span></label>
												<input type="text" class="form-control" placeholder="Question" id="title_vi" name="title_vi" value="<?= ($_SESSION['item_form']['title_vi'] != null) ? $_SESSION['item_form']['title_vi'] : $this->item->title_vi ?>">
												</div>


												<div class="control-group form-group">
												<label class="form-label">Answer (VI)</label>
												<textarea class="form-control" placeholder="Answer" id="description_vi" name="description_vi"><?= ($_SESSION['item_form']['description_vi'] != null) ? $_SESSION['item_form']['description_vi'] : Utility::convTextFromDB($this->item->description_vi) ?></textarea>
												</div>
	...
	function checkForm() {
		with (document.form1) {
			...
			if (document.getElementById('title_la').value == '') {
				swal(' Please fill out Question Field:');
				document.getElementById('title_la').focus();
				return false;
			}

			
			SetAction('faq-item-action.php');
		}
	}
