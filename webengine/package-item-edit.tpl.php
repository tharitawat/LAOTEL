									...
									<div class="text-wrap">
										<div class="example">
											...
											<div class="control-group form-group">
												...
												<input type="text" class="form-control" placeholder="Code" id="packageKey" name="packageKey" value="<?= ($_SESSION['item_form']['packageKey'] != null) ? $_SESSION['item_form']['packageKey'] : $this->item->packageKey ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Package Day</label>
												<input type="text" class="form-control" placeholder="qtaDay" id="qtaDay" name="qtaDay" value="<?= ($_SESSION['item_form']['qtaDay'] != null) ? $_SESSION['item_form']['qtaDay'] : $this->item->qtaDay ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Value</label>
												<input type="text" class="form-control" placeholder="qtaValue" id="qtaValue" name="qtaValue" value="<?= ($_SESSION['item_form']['qtaValue'] != null) ? $_SESSION['item_form']['qtaValue'] : $this->item->qtaValue ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Balance</label>
												<input type="text" class="form-control" placeholder="qtaBalance" id="qtaBalance" name="qtaBalance" value="<?= ($_SESSION['item_form']['qtaBalance'] != null) ? $_SESSION['item_form']['qtaBalance'] : $this->item->qtaBalance ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Promotion</label>
												<input type="text" class="form-control" placeholder="isPromotion" id="isPromotion" name="isPromotion" value="<?= ($_SESSION['item_form']['isPromotion'] != null) ? $_SESSION['item_form']['isPromotion'] : $this->item->isPromotion ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">VIP</label>
												<input type="text" class="form-control" placeholder="isVIP" id="isVIP" name="isVIP" value="<?= ($_SESSION['item_form']['isVIP'] != null) ? $_SESSION['item_form']['isVIP'] : $this->item->isVIP ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">Value Data</label>
												<input type="text" class="form-control" placeholder="Value Data" id="specialValue" name="specialValue" value="<?= ($_SESSION['item_form']['specialValue'] != null) ? $_SESSION['item_form']['specialValue'] : $this->item->specialValue ?>">
											</div>
											
											<div class="control-group form-group">
												<label class="form-label">USSD CODE</label>
												<input type="text" class="form-control" placeholder="USSD CODE" id="ussdCode" name="ussdCode" value="<?= ($_SESSION['item_form']['ussdCode'] != null) ? $_SESSION['item_form']['ussdCode'] : $this->item->ussdCode ?>">
											</div>
	...
	function checkForm() {
		...
		/*	
			...
			*/
			...
			SetAction('package-item-action.php');
		}
	}
