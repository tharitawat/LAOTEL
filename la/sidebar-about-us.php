<div class="left-menu-fix">
  <div class="left-menu-title">
      ...
      <div class="left-menu-title-flex">
        <div class="logo-title">
          <div id="dropdown-logo-inactive-1" class="dropdown-logo">
            <img src="./images/mobile-left-menu.svg" alt="Mobile" class="bright-white" />
          </div>
          <p id="logo-title-active-1">Mobile</p>
        </div>
    ...
    <div id="dropdown-left-1" class="dropdown-left">
      <a href="#" class="left-menu-dropdown " id="left-menu-dropdown-1.1">
        <div class="dropdown-logo-title">
          <div class="dropdown-logo">
            <img src="./images/M-phone.svg" class="bright-white" alt="M phone">
          </div>
          <p>coming soon</p>
        </div>
      </a>
  ...
  <div class="left-menu-title">
    ...
    <div class="dropdown-left" id="dropdown-left-4">
      <a href="#" class="left-menu-dropdown" id="left-menu-dropdown-4.1">
        <div class="dropdown-logo-title">
          <div class="dropdown-logo">
            <img src="./images/top-up-card.svg" alt="top up card" class="bright-white" style="height: 65%">
          </div>
          <p>coming soon</p>
        </div>
      </a>
  ...
  <div class="left-menu-title">
    ...
    <div id="dropdown-left-5" class="dropdown-left">
      ...
      <a href="news-event.php" class="left-menu-dropdown" id="left-menu-dropdown-5-2">
        <div class="dropdown-logo-title">
          <div class="dropdown-logo">
      ...
      <a href="career.php" class="left-menu-dropdown" id="left-menu-dropdown-5-3">
        <div class="dropdown-logo-title ">
